...
all_analysis = utils.get_analyze_df(
    dmu_ks=[
        ...
        'Yuanta Life 18', 'Yuanta Life 19', 'Yuanta Life 20', 
            ], df=denoise_nonpositive(LIFE181920),)
utils.round_analyze_df(all_analysis, round_to=4)#.to_excel("18-20 all_dmu analysis.xlsx")
#%%
no20 = all_analysis.loc[["20" not in idx for idx in all_analysis.index.tolist()]]
#%%
