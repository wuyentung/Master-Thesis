...
for k in dmus:
    ...
    break
# %%
utils.plot_3D(dmu=['Bank Taiwan Life 18', 'Bank Taiwan Life 19', 'Bank Taiwan Life 20'], stitle="Bank Taiwan Life",
              target_input="insurance_exp", smrts_dict=smrts_dict, df=denoise_nonpositive(LIFE181920)/1000/1000)
plt.draw()
plt.show()
# %%
